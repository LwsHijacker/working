...
import {UpdateBaseInfoProp, UpdatePasswordProp} from "@/pages/user/modules.ts";
...
export const userResetPassword = (data: UpdatePasswordProp): Promise<string> => {
    return https.request({
        url: '/user/resetPwd',
        method: 'post',
        data: data
...
// userCreate 用户修改
export const userUpdate = (data: UpdateBaseInfoProp): Promise<string> => {
    return https.request({
        url: '/user/update',
        method: 'post',
        data: data
...
export const userBaseInfoUpdate = (data: UpdateBaseInfoProp): Promise<string> => {
    return https.request({
...
// getUserInfo 用户详情页接口
export const getUserInfo = (userId: number): Promise<User.UserInfoPropResponse> => {
    return https.request({
        url: '/user/info',
        method: 'get',
        params: {userId: userId}
