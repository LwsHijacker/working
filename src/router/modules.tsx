...
namespace RouterVariate {
    ...
    export enum RouterEnum {
        ...
        MeetingNavPage,
        MeetingUserRegPage,
        MeetingUserRegStatusQuery,
        MeetingUserRegHelper,
        MeetingPage,
        SubMeetingPage,
        MeetingUserPage,
        MeetingUserPayDoc,
        MeetingAccountPage,
        MeetingUserLoginPage,
        MeetingUserSign,
        MeetingMakeInvoiceQueryPage,
    ...
    export const getRouter = (key: RouterEnum): React.ReactElement | undefined => {
        switch (key) {
            ...
            //会议用户注册相关功能
            case RouterEnum.MeetingNotice:
                return lazyLoad(() => import("@/pages/meeting/notice"));
            case RouterEnum.MeetingNavQrcode:
                return lazyLoad(() => import("@/pages/meeting/user/qrcode"));
            case RouterEnum.MeetingNavPage:
                return lazyLoad(() => import("@/pages/meeting/user/nav"));
            case RouterEnum.MeetingUserRegPage:
                return lazyLoad(() => import("@/pages/meeting/user/reg"));
            case RouterEnum.MeetingUserPayDoc:
                return lazyLoad(() => import("@/pages/meeting/user/paydoc"));
            case RouterEnum.MeetingUserRegStatusQuery:
                return lazyLoad(() => import("@/pages/meeting/user/regstatus"));
            case RouterEnum.MeetingUserRegHelper:
                return lazyLoad(() => import("@/pages/meeting/user/helper"));
            case RouterEnum.MeetingAccountPage:
                return lazyLoad(() => import("@/pages/meeting/user/account"));
            case RouterEnum.MeetingUserLoginPage:
                return lazyLoad(() => import("@/pages/meeting/user/loggin"));
            case RouterEnum.MeetingUserSign:
                return lazyLoad(() => import("@/pages/meeting/user/sign"));
            case RouterVariate.RouterEnum.MeetingMakeInvoiceQueryPage:
                return lazyLoad(() => import("@/pages/meeting/makeinvoice"))
            //后台的
            case RouterEnum.MeetingPage:
                return lazyLoad(() => import("@/pages/meeting"));
            case RouterEnum.SubMeetingPage:
                return lazyLoad(() => import("@/pages/meeting/submeeting"));
            case RouterEnum.MeetingUserPage:
                return lazyLoad(() => import("@/pages/meeting/user"));
    ...
    export const menuTitleItems: Menus.MenuTitleProp[] = [
        ...
        {title: '会议管理', path: '/bz/meeting'},
        {title: '参会用户', path: '/bz/meeting/user'},
        {title: '开票管理', path: '/bz/meeting/make/invoice'},
