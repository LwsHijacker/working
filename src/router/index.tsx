...
namespace RouterSpace {
    ...
    const parseMenus = (data?: Menus.MenuItemProp[]): [string[], string[]] => {
        ...
        // 返回
        return data ? [getMenuPath(data), getMenuButton(data)] : [[], []]
    }
    ...
    export const routers = [
        ...
        {
            path: '/meeting/qrcode',
            element: getRouter(RouterEnum.MeetingNavQrcode)
        },
        {
            path: '/meeting/nav',
            element: getRouter(RouterEnum.MeetingNavPage)
        },
        {
            path: '/meeting/notice',
            element: getRouter(RouterEnum.MeetingNotice)
        },
        {
            path: '/meeting/user/reg',
            element: getRouter(RouterEnum.MeetingUserRegPage)
        },
        {
            path: '/meeting/pay/account',
            element: getRouter(RouterEnum.MeetingAccountPage)
        },
        {
            path: '/meeting/user/pay',
            element: getRouter(RouterEnum.MeetingUserPayDoc)
        },
        {
            path: '/meeting/user/reg/helper',
            element: getRouter(RouterEnum.MeetingUserRegHelper)
        },
        {
            path: '/meeting/user/status/query',
            element: getRouter(RouterEnum.MeetingUserRegStatusQuery)
        },
        {
            path: '/meeting/user/login',
            element: getRouter(RouterEnum.MeetingUserLoginPage)
        },
        {
            path: '/meeting/user/sign',
            element: getRouter(RouterEnum.MeetingUserSign)
        },
        {
            id: Router.LayoutId,
            ...
            children: [
                ...
                {
                    path: '/bz/meeting',
                    element: getRouter(RouterEnum.MeetingPage),
                },
                {
                    path: 'bz/meeting/submeeting',
                    element: getRouter(RouterEnum.SubMeetingPage),
                },

                {
                    path: '/bz/meeting/user',
                    element: getRouter(RouterEnum.MeetingUserPage),
                },
                {
                    path: '/bz/meeting/make/invoice',
                    element: getRouter(RouterEnum.MeetingMakeInvoiceQueryPage),
                },
                {
